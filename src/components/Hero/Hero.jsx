...
const HeroData = [
    {
        ...
        title: "Wireless",
        title2: "Headphone",
        description: "If you provide the exact details of the vulnerabilities, I can help you with more specific advice on how to address them."
    },
    {
        id: 2,
        img: Image2,
                                ...
                                <div key={data.id}>
                                    <div className='grid grid-cols-1 sm:grid-cols-2'>
                                        <div className='flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10'>
                                            ...
                                            <div data-aos="fade up" data-aos-duration="500" data-aos-offset="0" data-aos-delay="300"><Button text="Shop By Category" bgColor="bg-primary" textColor="text-white" handleOrderPopup={handleOrderPopup} /></div>
                                        </div>
