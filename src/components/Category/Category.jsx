                    ...
                    <div className="py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-320px flex items-end">
                        <div>
                            <div className="mb-4">
                                ...
                                <p className='text-2xl font-semibold mb-[2px]'>With</p>
                                <p className="text-4xl xl:text-5xl font-bold opacity-80 mb-2">Gadget</p>
                                <Button
                        ...
                        <img src={Image2} alt="" className='w-[300px] absolute -right-8 sm:' />
                    </div>

                    {/* Third */}
                    <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-320px flex items-end lg:pr-20">
                        <div>
                        ...
                        <img src={Image3} alt="" className='sm:w-[300px] w-[200px] absolute top-1/2 -translate-y-1/2 right-0 lg:right-24' />
                    </div>
                </div>
            </div>
        </div>
